...
| 형상관리 | bandalgomim | PR 검토 및 머지 담당 |
...
### Step 3 — develop 최신화 반영 (주기적으로 + PR 전 필수)
...
> `develop` 브랜치를 타겟으로 PR을 생성합니다.

> ⚠️ 충돌 방지를 위해 PR 올리기 전에 반드시 Step 3을 먼저 수행합니다.
