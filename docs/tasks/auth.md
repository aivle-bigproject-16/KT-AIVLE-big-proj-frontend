...
| 2026-07-13 | 회원가입 페이지 버튼 위치 조절 (`1a8a09b`) | 로그인 화면 초안 생성 (`4a1674d`) · 회원가입 페이지 초안 구현 (`19fd034`) · 컴포넌트 디렉터리 재배치 (`59328ca`) · auth 컴포넌트 분리 (`be08944`) | API 명세 반영 수정 (`a9b2b1b`) | API 명세 반영 수정 (`a9b2b1b`) |
| 2026-07-16 | 로그인/회원가입 화면 좌측 배경사진 추가 (`ddf4fd0`) |  |  |  |
...
| `feat/login` | `ddf4fd0` | 2026-07-16 | style: 로그인/회원가입 화면 좌측에 배경사진 추가 |